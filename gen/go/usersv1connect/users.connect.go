...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/sa3akash/proto-package-example/gen/go/users/v1"
	http "net/http"
	strings "strings"
)
...
func NewUserServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) UserServiceClient {
	...
	userServiceMethods := v1.File_users_proto.Services().ByName("UserService").Methods()
...
func (UnimplementedUserServiceHandler) CreateUser(context.Context, *connect.Request[v1.CreateUserRequest]) (*connect.Response[v1.CreateUserResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("users.v1.UserService.CreateUser is not implemented"))
}
